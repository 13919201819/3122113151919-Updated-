...
// import { FaArrowDown, FaEye, FaCode, FaChartLine } from "react-icons/fa";
...
//       description: "A breathtaking online store that turns shopping into an emotional journey, with seamless UI and AI-driven personalization.",
//       image: "/placeholder-web.jpg", // Replace with actual image path
//       tech: ["React", "Node.js", "Tailwind"],
//       link: "#",
//     },
//     {
//       title: "Corporate Portal Masterpiece",
//       description: "An elegant portal that redefines corporate presence with fluid animations and a story-driven interface.",
//       image: "/placeholder-portal.jpg",
...
//   MobileApps: [
//     {
//       title: "Fitness Odyssey App",
//       description: "A transformative fitness app that inspires users with immersive workouts and real-time progress visuals.",
//       image: "/placeholder-fitness.jpg",
//       tech: ["Flutter", "Firebase", "AR"],
//       link: "#",
//     },
//     {
//       title: "Travel Dreamscape",
//       description: "An app that transports users to their dream destinations with stunning 3D previews and intuitive navigation.",
...
//       description: "Unleash creativity with an AI that paints emotions onto the canvas, leaving users speechless.",
//       image: "/placeholder-ai.jpg",
//       tech: ["TensorFlow", "Python", "WebGL"],
//       link: "#",
//     },
//     {
//       title: "Predictive Analytics Suite",
//       description: "A visionary tool that forecasts trends with stunning accuracy, igniting business growth.",
//       image: "/placeholder-analytics.jpg",
//       tech: ["PyTorch", "Django", "D3.js"],
//       link: "#",
//     },
//   ],
// };
...
//           setActiveCategory(Object.keys(projects)[index]);
//         }
//       });
//     };
...
//         <motion.h1
//           className="relative z-10 text-5xl md:text-7xl font-extrabold uppercase bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-700 drop-shadow-[0_0_30px_rgba(79,70,229,0.8)]"
//           variants={heroVariants}
//         >
//           Unleash Your Vision
//         </motion.h1>
//         <motion.p
//           className="relative z-10 max-w-2xl mt-4 text-xl text-gray-300 md:text-2xl"
//           variants={heroVariants}
//         >
...
//         {Object.entries(projects).map(([category, projectsList], index) => (
//           <motion.div
//             key={category}
...
// const cardVariants = {
//   hover: {
//     scale: 1.05, // Zoom effect instead of tilt
//     boxShadow: "0 20px 40px rgba(79, 70, 229, 0.4), 0 0 10px rgba(147, 51, 234, 0.3)",
//     transition: { duration: 0.4 },
//   },
//   tap: { scale: 0.98, transition: { duration: 0.2 } },
