...
// const ContactInfoItem = ({ icon, text, delay }: { icon: JSX.Element; text: string; delay: number }) => (
//   <motion.div
...
//             className="w-full px-4 py-3 text-gray-900 placeholder-gray-400 transition-all duration-300 border border-gray-600 rounded-lg bg-gray-800/50 focus:outline-none focus:ring-2 focus:ring-blue-500 glow-border"
//           >
...
//             id="name"
//             name="name"
//             className="w-full px-4 py-3 text-gray-200 placeholder-gray-400 transition-all duration-300 border border-gray-600 rounded-lg bg-gray-800/50 focus:outline-none focus:ring-2 focus:ring-blue-500 glow-border"
...
//                 id="resume"
//                 name="resume"
//                 className="w-full px-4 py-3 text-gray-200 transition-all duration-300 border border-gray-600 rounded-lg bg-gray-800/50 focus:outline-none focus:ring-2 focus:ring-blue-500 glow-border"
//               />
//             </motion.div>
//           ) : null}
//         </AnimatePresence>
...
//             className="fixed p-4 rounded-lg shadow-lg bottom-6 right-6 bg-gradient-to-r from-blue-500 to-purple-600 glow-effect"
//             whileHover={{ scale: 1.05, boxShadow: "0 0 20px rgba(59, 130, 246, 0.5)" }}
//           >
