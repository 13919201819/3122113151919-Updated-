...
//   // Predefined responses for demonstration (you can replace this with a real Agentic AI system)
//   const responses: { [key: string]: string } = {
//     "what is clumoss?": "CLUMOSS is an AI & Innovation Hub transforming industries with AI-powered SaaS solutions.",
//     "how can i contact clumoss?": "You can reach out via the Contact section on our website at /#contact.",
//     "what services does clumoss offer?": "CLUMOSS offers AI-powered SaaS solutions, including automation, data analytics, and more. Check out /#services for details.",
//     "default": "I’m not sure how to answer that. Could you rephrase your question, or check out our website for more info?",
//   };
...
//     // Simulate Agentic AI response (replace with real AI logic in production)
//     const aiResponse =
//       responses[userInput.toLowerCase()] || responses["default"];
...
//       {/* Chat Window */}
//       {isOpen && (
//         <div className="absolute right-0 p-4 text-white bg-gray-800 rounded-lg shadow-lg bottom-12 w-80">
//           <div className="flex items-center justify-between mb-3">
//             <h3 className="text-sm font-semibold">CLUMOSS AI Assistant</h3>
//             <button
...
//           {/* Chat History */}
//           <div className="h-48 p-2 mb-3 overflow-y-auto bg-gray-900 rounded">
...
//               className="flex-1 p-2 text-white bg-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-400"
//             />
//             <button
//               type="submit"
...
//   // Predefined responses for demonstration (replace with real Agentic AI in production)
//   const responses: { [key: string]: string } = {
//     "what is clumoss?": "CLUMOSS is an AI & Innovation Hub transforming industries with AI-powered SaaS solutions.",
//     "how can i contact clumoss?": "You can reach out via the Contact section on our website at /#contact.",
//     "what services does clumoss offer?": "CLUMOSS offers AI-powered SaaS solutions, including automation, data analytics, and more. Check out /#services for details.",
...
//     const aiResponse = responses[userInput.toLowerCase()] || responses["default"];
//     setChatHistory((prev) => [...prev, { sender: "ai", message: aiResponse }]);
...
//       {/* Chat Window */}
//       {isOpen && (
//         <div className="absolute right-0 p-4 text-white bg-gray-800 rounded-lg shadow-lg bottom-16 w-80">
//           <div className="flex items-center justify-between mb-3">
//             <h3 className="text-sm font-semibold">CLUMOSS AI Assistant</h3>
//             <button
//               onClick={() => setIsOpen(false)}
...
//   // Play voice response
//   const playVoice = (audio: HTMLAudioElement) => {
//     audio.currentTime = 0;
...
//     "how can i contact clumoss?": "You can reach out via the Contact section on our website at /#contact.",
//     "what services does clumoss offer?": "CLUMOSS offers AI-powered SaaS solutions, including automation, data analytics, and more. Check out /#services for details.",
//     "default": "I’m not sure how to answer that. Could you rephrase your question, or select an option below?",
//   };
...
//         playVoice(scheduleVoice);
//         speakText("Great! Let's schedule your client call.");
//         setChatHistory((prev) => [
//           ...prev,
...
//         playVoice(demoVoice);
//         speakText("Here’s a demo of our projects.");
//         setChatHistory((prev) => [
//           ...prev,
...
//         playVoice(projectAnalysisVoice);
//         speakText("Please share your project idea, and I’ll analyze it for you.");
//         setChatHistory((prev) => [
//           ...prev,
...
//         break;
//       case "What we do":
//         playVoice(whatWeDoVoice);
//         speakText("Here’s what we do at CLUMOSS.");
//         setChatHistory((prev) => [
//           ...prev,
...
//     playFuturisticSound();
//     playVoice(projectAnalysisVoice);
//     speakText("I’ve analyzed your project idea. Here’s the timeline and completion plan.");
...
//       speakText("Hello, I am your CLUMOSS AI Assistant. What would you like to know?");
//       setChatHistory([{ sender: "ai", message: "Hello! I am your CLUMOSS AI Assistant. What would you like to know?" }]);
//     }
//   }, [isOpen]);
...
//   // Fetch response from Hugging Face API (Llama-3.3-70B-Instruct)
...
//       return "I’m sorry, I couldn’t process your request. Please try again or select an option below.";
//     } finally {
//       setIsLoading(false);
//     }
//   };
...
//       const aiResponse = predefinedResponses[lowerInput];
//       setChatHistory((prev) => [...prev, { sender: "ai", message: aiResponse }]);
//       speakText(aiResponse); // Speak the predefined response
//     } else {
//       // Fetch response from Hugging Face API (Llama-3.3-70B-Instruct)
...
//   // Fetch response from Hugging Face API (Llama-3.3-70B-Instruct)
//   const fetchAIResponse = async (message: string, isTest: boolean = false) => {
//     setIsLoading(true);
//     try {
//       const response = await fetch("/api/hf-chat", {
//         method: "POST",
...
//       if (isTest) {
//         // For test mode, return detailed API response
//         return `API Test Result:\n- Status: ${data.status}\n- Generated Response: ${data.response}\n- Raw Response: ${JSON.stringify(data.rawResponse, null, 2)}`;
//       }
...
//       console.error("Error fetching AI response:", error);
//       if (isTest) {
//         return `API Test Failed:\n- Error: ${error.message}\n- Please check your Hugging Face token and model access.`;
//       }
//       return `Error: ${error.message}. Please try again or select an option below.`;
//     } finally {
//       setIsLoading(false);
//     }
//   };
...
//     if (lowerInput === "test api") {
//       const testMessage = "Hello, how can I help you today?";
//       const testResponse = await fetchAIResponse(testMessage, true);
//       setChatHistory((prev) => [...prev, { sender: "ai", message: testResponse }]);
//       speakText("API test completed. Check the chat for details.");
//     }
...
//         { sender: "ai", message: "Type 'test api' to check if the Hugging Face API is working." },
//       ]);
//     }
//   }, [isOpen]);
