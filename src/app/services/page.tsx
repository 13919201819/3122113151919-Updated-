...
//           <h1 className="text-5xl md:text-6xl font-extrabold uppercase bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-purple-600 drop-shadow-[0_0_15px_rgba(0,204,255,0.7)] mb-6">
//             Services
//           </h1>
//           <p className="max-w-2xl mx-auto text-lg text-gray-200 md:text-xl">
//             Explore our comprehensive services designed to elevate your business with cutting-edge technology.
//           </p>
//         </div>
//       </div>
//     );
